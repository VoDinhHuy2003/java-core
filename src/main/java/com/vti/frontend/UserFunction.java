...
public class UserFunction {
    ...
    private void findAll() throws SQLException {
        ...
        System.out.println("+------+------------------------+------------------------+");
        System.out.printf("| %-4s | %-22s | %-22s |%n", "ID", "FULL NAME", "EMAIL");
        System.out.println("+------+------------------------+------------------------+");
        if(users.isEmpty()) {
            System.out.printf("| %-4s | %-22s | %-22s |%n", "NULL", "NULL", "NULL");
            System.out.println("+------+------------------------+------------------------+");
        }
        else {
            for (User user : users) {
                System.out.printf("| %-4s | %-22s | %-22s |%n",user.getId(), user.getFullName(), user.getEmail());
                System.out.println("+------+------------------------+------------------------+");
            }
        }
    }
    ...
    private void create() throws SQLException {
        System.out.println("Mời bạn nhập vao thông tin user.");
